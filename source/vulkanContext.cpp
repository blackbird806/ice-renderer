...
void VulkanContext::endSingleTimeCommands(vk::CommandBuffer cmdBuff)
{
	cmdBuff.end();
...
void VulkanContext::copyBuffer(vk::Buffer src, vk::Buffer dst, vk::DeviceSize size)
{
...
void VulkanContext::copyBufferToImage(vk::Buffer src, vk::Image dst, uint32 width, uint32 height)
{
...
void VulkanContext::transitionImageLayout(vk::Image image, vk::Format format, uint32 miplevel, vk::ImageLayout oldLayout,
...
void VulkanContext::createImage(uint32_t width, uint32_t height, vk::Format format, vk::ImageTiling tiling, vk::ImageUsageFlags usage,
...
void VulkanContext::createInstance(std::span<const char*> validationLayers)
{
...
void VulkanContext::createDevice(std::span<const char*> requiredExtensions)
{
...
void VulkanContext::updateUniformBuffer(int32 currentFrame)
{
...
void VulkanContext::destroyTextureImage()
{
...
void VulkanContext::destroySyncPrimitives()
{
	for (int i = 0; i < c_maxFramesInFlight; i++)
	{
